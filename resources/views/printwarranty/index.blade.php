...
@section('content')
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-1">
                <div class="d-flex gap-2">
                    <button id="searchCard" class="btn btn-primary flex-fill">Tìm kiếm</button>
                    <button id="resetFilters" class="btn btn-outline-secondary">Xóa bộ lọc</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="{{ asset('js/printwarranty/validation.js') }}"></script>
