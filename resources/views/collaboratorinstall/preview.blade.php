...
<script src="{{ asset('js/collaboratorinstall/preview.js') }}"></script>
<script>
    // Global variables for JavaScript
    window.START_DATE = "{{ request('start_date') }}";
    window.END_DATE = "{{ request('end_date') }}";
    window.ROUTES = {
        collaborator_export: "{{ route('collaborator.export') }}"
    };
</script>
<script src="{{ asset('js/Collaborator_Install/preview_Collaborator_Install/sheet-switching.js') }}"></script>
<script src="{{ asset('js/Collaborator_Install/preview_Collaborator_Install/download.js') }}"></script>
<script src="{{ asset('js/Collaborator_Install/preview_Collaborator_Install/main.js') }}"></script>
@endsection
