...
<script>
    ...
    window.SERVER_TAB = '{{ $tab ?? "donhang" }}';
    window.PRODUCT_LIST = {!! json_encode($products ?? []) !!};
    window.ROUTES = {
        dieuphoi_tabdata: "{{ route('dieuphoi.tabdata') }}",
        dieuphoi_counts: "{{ route('dieuphoi.counts') }}",
        collaborator_export_preview: "{{ route('collaborator.export.preview') }}",
        upload_excel_sync: "{{ route('upload-excel-sync') }}"
    };
</script>
<script src="{{ asset('js/Collaborator_Install/Index/tab-management.js') }}"></script>
<script src="{{ asset('js/Collaborator_Install/Index/form-validation.js') }}"></script>
<script src="{{ asset('js/Collaborator_Install/Index/search.js') }}"></script>
<script src="{{ asset('js/Collaborator_Install/Index/pagination.js') }}"></script>
<script src="{{ asset('js/Collaborator_Install/Index/table-drag.js') }}"></script>
<script src="{{ asset('js/Collaborator_Install/Index/excel-upload.js') }}"></script>
<script src="{{ asset('js/Collaborator_Install/Index/report.js') }}"></script>
<script src="{{ asset('js/Collaborator_Install/Index/main.js') }}"></script>
@endsection