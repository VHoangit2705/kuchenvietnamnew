...
<body>
    ...
    <script>
        ...
        window.listProblemRoute = @json(route('listproblem'));
        window.updateStatusRoute = @json(route('updatestatus'));
        window.csrfToken = '{{ csrf_token() }}';
    </script>
    <script src="{{ asset('js/problem-common.js') }}"></script>
    <script src="{{ asset('js/detailproblem.js') }}"></script>
</body>
</html>