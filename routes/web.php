...
Route::prefix('baohanh/tailieukithuat')->group(function () {
    Route::get('/get-products-by-category', [TechnicalDocumentController::class, 'getProductsByCategory'])->name('warranty.document.getProductsByCategory');
    Route::get('/get-origins-by-product', [TechnicalDocumentController::class, 'getOriginsByProduct'])->name('warranty.document.getOriginsByProduct');
    Route::get('/get-models-by-origin', [TechnicalDocumentController::class, 'getModelsByOrigin'])->name('warranty.document.getModelsByOrigin');
    Route::get('/get-errors-by-model', [TechnicalDocumentController::class, 'getErrorsByModel'])->name('warranty.document.getErrorsByModel');
    Route::get('/get-error-detail', [TechnicalDocumentController::class, 'getErrorDetail'])->name('warranty.document.getErrorDetail');
    Route::get('/download-all-documents', [TechnicalDocumentController::class, 'downloadAllDocuments'])->name('warranty.document.downloadAllDocuments');
